...
print(glue("Bob's total savings with the ORP plan, averaged on the various markets he invested in, would give him a final investment portfolio of {dollar(bob_total_savings)}.00.\nThat is significantly more than he received from the TRP."))
```
