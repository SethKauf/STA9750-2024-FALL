...
```{r bobs-expenses_[27], echo=FALSE, message=FALSE, warning=FALSE}
...
```{r bob-withdrawls-pension_[28], echo=FALSE, message=FALSE, warning=FALSE}
# bringing in pension
...
```{r bob-withdrawls-fund_[29], echo=FALSE, message=FALSE, warning=FALSE}
