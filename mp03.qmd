...
shapefiles |>
  DT::datatable()
```
This tells us the date-range that each `district` shapefile corresponds to. The number in the filename represents the election cycle for that district. This will be useful for further analysis.
...
This was a particularly contentious election that was [famously decided by the Supreme Court](https://www.nytimes.com/2000/12/13/us/bush-prevails-single-vote-justices-end-recount-blocking-gore-after-5-week.html) due to the uncertainty of the balloting system in Florida.



<figure style="text-align: center; margin-top: 20px;">
  <img src="http://blogs.smithsonianmag.com/design/files/2012/11/butterfly-ballot_470.jpg" alt="Florida Butterfly Ballot" style="width: 600px; height: auto;">
  <figcaption>Sample *Butterfly Ballot* in Florida from the 2000 Presidential Election</figcaption>
</figure>
...
combined_ev_data <- evs_by_year |>
  ...
  mutate(dem_diff = dem_totals_regular - dem_totals_adjusted, # create differential cols
         rep_diff = rep_totals_regular - rep_totals_adjusted,
         lib_diff = lib_totals_regular - lib_totals_adjusted,
         oth_diff = oth_totals_regular - oth_totals_adjusted,
...
combined_ev_data |>
  ...
  rename(
    ...
    "Difference in Democrat ECVs" = `rep_diff`,
